...
grid = [[50, 150, 250, 350, 450,550], [50, 150, 250, 350, 450, 550]]
...
as created by a 6x6 grid'''
    
# Red Circle Pair
        
RedCircle1 = CircleRender.grid_circle(grid[0][2], grid[1][2], Red)
RedCircle2 = CircleRender.grid_circle(grid[0][4], grid[1][4], Red)
RedCircle1.render()
RedCircle2.render()
        
# Blue Circle Pair
        
BlueCircle1 = CircleRender.grid_circle(grid[0][5], grid[1][4], Blue)
BlueCircle2 = CircleRender.grid_circle(grid[0][3], grid[1][5], Blue)
BlueCircle1.render()
BlueCircle2.render()
        
# Green Circle Pair
        
GreenCircle1 = CircleRender.grid_circle(grid[0][3], grid[1][3], Green)
GreenCircle2 = CircleRender.grid_circle(grid[0][1], grid[1][4], Green)
GreenCircle1.render()
GreenCircle2.render()
...
OrangeCircle1 = CircleRender.grid_circle(grid[0][5], grid[1][0], Orange)
OrangeCircle2 = CircleRender.grid_circle(grid[0][3], grid[1][4], Orange)
OrangeCircle1.render()
OrangeCircle2.render()
        
# Yellow Circle Pair
        
YellowCircle1 = CircleRender.grid_circle(grid[0][1], grid[1][2], Yellow)
YellowCircle2 = CircleRender.grid_circle(grid[0][5], grid[1][3], Yellow)
